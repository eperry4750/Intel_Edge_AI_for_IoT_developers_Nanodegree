...
MODEL_PATH = r"C:\Users\eperr\Anaconda3\Scripts3\Edge\inference_requests\models"
...
def pose_test():
    counter = 0
    model = MODEL_PATH + r"\human-pose-estimation-0001.xml"
...
def text_test():
    counter = 0
    model = MODEL_PATH + r"\text-detection-0004.xml"
...
def car_test():
    counter = 0
    model = MODEL_PATH + r"\vehicle-attributes-recognition-barrier-0039.xml"
